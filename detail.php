...
<div class="container"> 
  ...
  <!-- Contents -->      
    <div id="toc">
	 ...
	 <div class="_chd-cl-xs-12-md-04-lg-03">	
     <article class="reader _self-cl-md-08-lg-09">
     	<header class="_chd-cl-xs-12-sm-04">
        	<h1 class="_self-cl-sm-08-pd0">ตะบันตำ ตำถาดบันลือโลก</h1>
            <!-- write social -->
        ...
        <figure class="cover">
        	<div id="vdo" class="embed-resp 16by9">
        	<iframe title="YouTube video player" src="http://www.youtube.com/embed/G9MJyewRQ28?autoplay=1&amp;wmode=transparent&amp;rel=0" allowfullscreen="" width="100%" height="336" frameborder="0"></iframe>
            </div>
            <!--<img src="http://www.aroilert.com/static/ud/reedv/1/1/2719/DSC04975.jpg" title="ตะบันตำ ตำถาดบันลือโลก สาขาปิ่นเกล้า (ต้นตำรับ)">-->
            <figcaption class="hid">ตะบันตำ ตำถาดบันลือโลก สาขาปิ่นเกล้า (ต้นตำรับ)</figcaption>
        </figure>
        <div id="photo" class="editor">
        	 <p><span><i class="fa-clock-o"></i> อัพโหลดเมื่อ : 23/08/2017</span> |   <span><i class="fa-eye"></i> เข้าชม : 543</span> </p>
            <p id="fix-desc" class="hauto">อาหารไทย-อีสานต้นตำรับ รสแซบจัดจ้าน! ที่ได้รับการตอบรับดีเยี่ยมจากลูกค้ากว่า 10 ปี นั่นเป็นเพราะสูตรอาหารรสแซบได้มาตรฐาน และเครื่องปรุงและวัตถุดิบทุกอย่าง ทำเองสดใหม่วันต่อวันกันเลยทีเดียวค่ะ!
.
ทางร้านเปิดขยายแฟรนไชส์ จังหวัดละ 1 สาขาเท่านั้น! 081-934-7155, 094-296-5639ร้านตะบันตำ ตำถาดบันลือโลก สาขาปิ่นเกล้า (ต้นตำรับ)  OA. 23-08-60<br>
<br>
ร้านส้มตำที่มีชื่อเสียงโด่งดังจากเมนูตำถาด การันตีด้วยลูกค้าที่เข้าคิวยาว จึงใช้ชื่อว่าตำถาดบันลือโลก และสิ่งที่ดึงดูดมัดใจลูกค้าถึงกับต้องเข้าคิวยาวนั่นคือเมนู ตำถาดไทย ซึ่งได้รวบรวมวัตถุดิบหลากหลายอย่างอยู่ในถาดเดียว ได้แก่ ส้มตำไทย, ปลาดุกฟู, ไก่ทอด, ผักรวมทอด, หมูยอ, หมี่ลวก, ขนมจีน, ผักกาดขาว, แคบหมู, ไข่ต้ม นอกจากนี้ลูกค้ายังสามารถเลือกเป็นตำถาดป่า, ตำถาดลาวได้อีกด้วย และทีเด็ดคือ เราจะชูโรงด้วยน้ำปรุงรสสูตรเฉพาะ เป็นน้ำปรุงที่เคี่ยวประมาณ 6-8 ชม. จะทำให้รสชาติส้มตำเด่นขึ้นมาแปลกกว่าที่อื่น ท้าให้ลิ้มลอง<br>
<br>
ตั้งอยู่ที่ ถนนบรมราชชนนี ร้านอยู่ภายในตลาดปิ่นเงิน พลาซ่า ด้านในสุด ตรงข้ามเซ็นทรัล พลาซา ปิ่นเกล้า<br>
<br>
โทร. 081-934-7155, 094-296-5639<br>
<br>
---------------------------------------------------------------<br>
...
FB : aroilert</p>
        ...
        <div class="z-gallery">
            <h2 class="h-text">แกลอรี่ : ร้านครัวเลิศรส</h2>
        ...
        <div class="z-maps">
           ...
           <!-- <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3874.9961646951488!2d100.47522551529188!3d13.779104590329842!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e29986e62b3d5d%3A0xea65a04f6c46a0b2!2z4Lij4LmJ4Liy4LiZ4LiV4Liw4Lia4Lix4LiZ4LiV4LizIOC4leC4s-C4luC4suC4lOC4muC4seC4meC4peC4t-C4reC5guC4peC4gQ!5e0!3m2!1sth!2sth!4v1503471707281" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>-->
            ...
            <div class="info">
            	<p><b>ประเภทอาหาร</b> : อาหารไทย-ฮีสาน</p>
            	<address><b>ตั้งอยู่ที่</b> :  ถนนบรมราชชนนี ร้านอยู่ภายในตลาดปิ่นเงิน พลาซ่า ด้านในสุด ตรงข้ามเซ็นทรัล พลาซา ปิ่นเกล้า</address>
                <p><b>โทร.</b> : 081-934-7155, 094-296-5639</p>
                <p><b>เว็บไซต์</b> : facebook: @tomnue</p>
                <p><b>เวลาเปิด-ปิด</b> : ทุกวัน 10:00–20:30 น.</p>
            </div>
            </div>
     ...
     <div id="sr-box-fix">
        ...
        <div class="sr-tips">
        	<h3 class="h-text"><a class="t-pink" href="archive.php" title="๊UPDATE">รวมเรื่องมาใหม่</a></h3>
            <div class="thm-top _chd-cl-xs-06 img-resp">
            <article>
                    <div class="in">
                     <a title="เตี๋ยวกะตำ สาขาเคหะร่มเกล้า 13" href="detail.php#vdo">
                        <div>
                        <img src="http://www.aroilert.com/static/ud/reed_review/1/97/20-216x216.jpg" width="280">
                        <i class="fa-play"></i>
                        </div>
                        <h3>เตี๋ยวกะตำ สาขาเคหะร่มเกล้า 13</h3>
                        </a>
                    </div>
                </article>
                <article>
                    <div class="in">
                      <a title="Paradise Dynasty" href="detail.php#photo">
                        <div>
                        <img src="http://www.aroilert.com/static/ud/reed_review/1/96/20-216x216.jpg" width="280">
                        </div>
                        <h3>Paradise Dynasty</h3>
                        </a>
                    </div>
                </article>
  ...
  <section class="sec-rec ct-related">
    ...
    <div class="ctrl-btn cb _self-mb30">
    	<a class="ui-btn-border" href="archive.php" title="ดูทั้งหมด">ดูทั้งหมด</a>
    </div>
  </section> 
...
<div class="cm-fb">
<div class="fb-comments" data-href="http://www.reedicious.com/reviewdetail/2719" data-width="1170" data-numposts="5"></div>
</div>
</div>
...
<script src="../../js/gb-scroll-sharesocial-v1.js" type="text/javascript"></script>
<script src="../../js/gb-sharesocial-v1.js" type="text/javascript"></script>

<!--<script src="http://ui.files-media.com/js/gb-scroll-sharesocial-v1.js?2017" type="text/javascript"></script>
<script src="http://ui.files-media.com/js/gb-sharesocial-v1.js?2017" type="text/javascript"></script>-->
 <script type="text/javascript">
  //<![CDATA[
  document.write('<link rel="stylesheet" type="text/css" href="../../themes/common/cs/gb-sharesocial.css?v2017" />');
  //document.write('<link rel="stylesheet" type="text/css" href="http://ui.files-media.com/themes/common/cs/gb-sharesocial.css?v2017" />');
  //]]>
  </script>
