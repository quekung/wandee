...
<div class="container"> 
  ...
  <section class="sec-archive">
  	<h1 class="h-topic txt-l"><a href="archive.php" title="EVENTS"><span>EVENTS</span></span><small>&quot;รวมเรื่องเทศกาล&quot;</small></a></h1>
    ...
    <div class="pagination _self-mt0">
                            <ul>
                              <li>
                                <a title="Previous" href="#" class="btn">&lt; Previous</a>
                              </li>
                              <li>
                              ...
                              <li>
                                <a title="Next" href="#" class="btn">Next &gt;</a>
                              </li>
                            </ul>
                        </div>
    <!--<div class="ctrl-btn cb _self-mb30">
    	<a class="ui-btn-border" href="archive.php" title="ดูเพิ่ม">ดูเพิ่ม <i class="fa-angle-double-down"></i></a>
    </div>-->
  </section>  
